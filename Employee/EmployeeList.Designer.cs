namespace PoligonOtomasyonu
{
    partial class EmployeeList
    {
        ...
        private void InitializeComponent()
        {
            ...
            EmployeeListListView = new ListView();
            ...
            dateOfStartHeader = new ColumnHeader();
            dateOfFinishHeader = new ColumnHeader();
            employeeStatusHeader = new ColumnHeader();
            ...
            // 
            EmployeeListListView.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            EmployeeListListView.Columns.AddRange(new ColumnHeader[] { citizenIdHeader, nameHeader, midnameHeader, surnameHeader, genderHeader, birthdateHeader, bloodGroupHeader, countryHeader, cityHeader, countyHeader, addressHeader, phoneHeader, emailHeader, criminalRecordHeader, dateOfStartHeader, dateOfFinishHeader, employeeStatusHeader });
            EmployeeListListView.Location = new Point(12, 46);
            EmployeeListListView.Name = "EmployeeListListView";
            EmployeeListListView.Size = new Size(1331, 692);
            EmployeeListListView.TabIndex = 0;
            EmployeeListListView.UseCompatibleStateImageBehavior = false;
            EmployeeListListView.View = View.Details;
            EmployeeListListView.DoubleClick += MemberListListView_DoubleClick;
            // 
            // citizenIdHeader
            // 
            ...
            // dateOfStartHeader
            // 
            dateOfStartHeader.Text = "DateOfStart";
            // 
            // dateOfFinishHeader
            // 
            dateOfFinishHeader.Text = "DateOfFinish";
            // 
            // employeeStatusHeader
            // 
            employeeStatusHeader.Text = "employeeStatus";
            // 
            // pictureBox4
            // 
            ...
            pictureBox1.Size = new Size(1030, 40);
            ...
            Controls.Add(EmployeeListListView);
        ...
        private ListView EmployeeListListView;
        ...
        private ColumnHeader dateOfStartHeader;
        private ColumnHeader dateOfFinishHeader;
        private ColumnHeader employeeStatusHeader;
